...
public class MainFrame extends JFrame {
	...
	public void initialize(String sceneFilename, int canvasWidth,
		...
		if (sceneFilename != null) {
			Utils.setSceneFile(new File(sceneFilename));
		}
	...
	public void render() {
		...
		if (!loadSceneFromFile(Utils.getSceneFile())) {
			return;
		}
	...
	protected void showSceneFileOpenDialog() {
		...
		if (fd.showOpenDialog(this) == JFileChooser.APPROVE_OPTION) {
			...
			Utils.setSceneFile(fd.getSelectedFile());
			updateTitle();
		}
	}
	...
	protected void updateTitle() {
		...
		if (Utils.getSceneFile() != null)
			sceneFilename = Utils.getSceneFile().getName();
